                        ...
                        <div class="adv-table">
                            <div class="table-responsive">
                                <table class="display table table-bordered datatable" id="jr">
                                 <a class="btn btn-info" href="<?php echo base_url('Dashboard/referralxls')?>"  type="submit">Download</a>
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>User Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $user->referbyname.' '.$user->referbylastname; ?></td>
                                        <td><?php echo $user->referedbycount; ?></td>
