...
<div class="select_MOnth">
 <form role="form" method='POST' class="form-horizontal" action="<?php echo base_url('Dashboard/topdonors')?>" enctype="multipart/form-data">
...
?>
    ...
    <div id="menu1" class="tab-pane fade">
        ...
        <div class="adv-table">
                            <div class="table-responsive">
                                <table class="display table table-bordered datatable" id="jr">
                                 <a class="btn btn-info" href="<?php echo base_url('Dashboard/topdonorsyearxls')?>"  type="submit">Download Yearly</a>
                                    <thead>
                                        <tr>
                                            <th>Sr.No</th>
                                            <th>Id</th>
