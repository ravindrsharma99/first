        ...
        <div class="row state-overview">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <section class="panel">
                    ...
                    <div class="value">
                        <h1 class=" couxnt">
                                <?php  echo count($hb_organization); ?>
                              </h1>
                        <p>Organization</p>
                    </div>
                </section>
...
$ch_data = $ch_data . "['Spare Change'," . $spare . "],";
$ch_data = $ch_data . "['Reoccurring'," . $reoccurring . "],";
$ch_data = $ch_data . "['One-Time'," . $one_time . "],";
