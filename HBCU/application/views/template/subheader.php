<body>
  ...
  <section id="container" class="">
      ...
      <header class="header white-bg">
          ...
          <!--logo start-->
          <a href="<?php echo base_url(); ?>Dashboard" class="logo" >HBCU <span>Dashboard</span></a>
          <!--logo end-->
          ...
          ?>
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                          <img alt="" src="<?php echo base_url(); ?>Public/img/avatar-mini.jpg">
                          <span class="username"><?php echo $_SESSION['logged_in']->fname ?></span>
                          <b class="caret"></b>
                      </a>
