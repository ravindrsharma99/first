                                ...
                                <table class="display table table-bordered" id="jr">
                                  ...
                                  foreach ($elecData as $user) {?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="button_CLASS" href="javascript:void(0)"> <span class = "clickAction" id="unqButton<?php echo $user->id; ?>" revid = "<?php echo $user->id; ?>"  status = "<?php echo ($user->providersStatus == 1)?0:1;?>"><?php echo ($user->providersStatus ==1)?'Activated':'Inactive'; ?></span></a>
                                        </td>
                                    </tr>
                                    <?php $i++;
                                 }   
