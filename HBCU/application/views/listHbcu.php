                                ...
                                <table class="display table table-bordered datatable" id="jr">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "<img height='100' src='".base_url().$user->logo."' / >";?></td>
                                         <td><?php 
                                         if (!empty($user->image)) {
                                         echo "<img height='100' src='".base_url().$user->image."' / >";
                                        ...
                                        <td  class="alignment">
                                            ...
                                            data-image="<?php echo base_url().$user->image; ?>"
                                            data-organization="<?php echo $user->organization; ?>"
                                            class="btn btn-primary">Edit</a>

                                            <a href="<?php echo base_url('Dashboard/deleteHbcu').'/'.$user->id.'?action=user_list'; ?>"  data-userid="<?php echo $user->id; ?>" name="delete" onclick="return confirm('Are You Sure?')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $i++;
                                }
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <img src="" style="width:90px;height:auto;border-radius:50%" id="editimage" />
